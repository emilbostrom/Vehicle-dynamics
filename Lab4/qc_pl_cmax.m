...
ddz1 = (-c_max*(dz1-dz2)-ks*(z1-z2))/ms; % Sprung mass acceleration
ddz2 = (kt*zr-c_max*(dz2-dz1)-ks*(z2-z1)-kt*z2)/mus; % Unsprung mass acceleration
